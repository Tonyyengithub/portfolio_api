...
describe 'Test Collaborator Handling' do
  ...
  before do
    ...
    @account = Portfolio::Account.create(@account_data)
    @another_account = Portfolio::Account.create(@another_account_data)
    @wrong_account = Portfolio::Account.create(@wrong_account_data)
